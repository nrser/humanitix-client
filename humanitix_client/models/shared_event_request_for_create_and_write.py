...
T = TypeVar("T", bound="SharedEventRequestForCreateAndWrite")


@_attrs_define
class SharedEventRequestForCreateAndWrite:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shared_event_request_for_create_and_write = cls(
            name=name,
        ...
        shared_event_request_for_create_and_write.additional_properties = d
        return shared_event_request_for_create_and_write
